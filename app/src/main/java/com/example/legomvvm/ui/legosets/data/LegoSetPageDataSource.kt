...
class LegoSetPageDataSource @Inject constructor(
...
) : PageKeyedDataSource<Int, LegoSet>() {

    override fun loadInitial(
        params: LoadInitialParams<Int>,
        callback: LoadInitialCallback<Int, LegoSet>
    ) {
    ...
    private fun getJobErrorHandler() =
        CoroutineExceptionHandler { _, e -> postError(e.message ?: e.toString()) }

    private fun postError(message: String) {
        Timber.e("An error happend: $message")
    }
}